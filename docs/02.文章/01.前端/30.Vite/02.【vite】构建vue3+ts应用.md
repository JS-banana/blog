---
title: 【vite】构建vite + vue3 + setup + ts 项目
...
vite + vue3 + setup + ts 爽到飞起，谁用谁知道！我TM吹爆~
...
一个使用 vite + vue3 + Pinia + typescript + ant-design-vue 完整技术路线开发的项目
...
- Pinia
- TypeScript
- ant-design-vue / less / postcss
- Eslint / Prettier / Commitlint 工程规范支持
