...
::: warning
如果你正在寻找本博客的搭建文档，博主建议您查看这个仓库的[README](https://github.com/JS-banana/vuepress-theme-vdoing)。
:::
...
> git 操作部分和使用github的差不多，不了解git操作的可以看我的另一篇文章：[Git使用手册](https://sunss.com/pages/9a7ee40fc232253e/)
...
git add -A
git commit -m 'deploy'
git push -f git@github.com:sunss/blog.git master:gh-pages # 发布到github

# coding
echo 'sunss.com' > CNAME
git add -A
git commit -m 'deploy'
git push -f git@git.dev.tencent.com:sunss/sunss.git master # 发布到coding
